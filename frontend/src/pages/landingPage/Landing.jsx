  ...
  return (
    ...
    <div className="h-screen w-screen landing_page">
      ...
      <div className="w-full text-white text-center flex flex-col justify-center items-center gap-y-4 mt-14">
        ...
        <button className="px-3 py-2  text-white shadow-sm bg-orange-400 mt-9 rounded-xl hover:text-xl font-mono text-lg transition-all duration-200  outline-none">
                CREATE YOUR BLOG
        </button>
      </div>
      ...
      {/* blue background */}
      <img src={drone} alt="log1" className="_img_ _blue_animate  blue_drone" />
      <img src={blogImg} alt="log1" className=" _img_ _blue_animate _img_blog blue_blog" />
      <img src={heartBig} alt="log1" className="_img_ _blue_animate blue_heartbeat" />
      <img src={remote} alt="log1" className="_img_ _blue_animate blue_remote" />

      {/* green background */}
      <img src={green_blog   } alt="log1" className="_img_ _green_animate _img_blog green_blog   " />
      <img src={green_a      } alt="log1" className="_img_ _green_animate green_a      " />
      <img src={green_b      } alt="log1" className="_img_ _green_animate green_b      " />
      <img src={green_c      } alt="log1" className="_img_ _green_animate green_c      " />
      <img src={green_chappal} alt="log1" className="_img_ _green_animate green_chappal" />
      <img src={green_coffe  } alt="log1" className="_img_ _green_animate green_coffe  " />
      <img src={green_flowers} alt="log1" className="_img_ _green_animate green_flowers" />
      <img src={green_image  } alt="log1" className="_img_ _green_animate green_image  " />
     
      {/* red background */}
      <img src={red_blog  } alt="log1" className="_img_ _red_animate  _img_blog red_blog  " />
      <img src={red_apple } alt="log1" className="_img_ _red_animate red_apple " />
      <img src={red_belen } alt="log1" className="_img_ _red_animate red_belen " />
      <img src={red_fette } alt="log1" className="_img_ _red_animate red_fette " />
      <img src={red_spoon } alt="log1" className="_img_ _red_animate red_spoon " />
      <img src={red_plate } alt="log1" className="_img_ _red_animate red_plate " />
      <img src={red_plate2} alt="log1" className="_img_ _red_animate red_plate2" />
      <img src={red_cup   } alt="log1" className="_img_ _red_animate red_cup   " />
